...
public class Roller extends AbstractMiniGame {
	...
	private Timer tm2 = new Timer(700 - 35*schwierigkeit, t1);
	...
	private Timer tm3 = new Timer(700 - 35*schwierigkeit, t1);
	...
	private Timer tm4 = new Timer(700 - 35*schwierigkeit, t1);
